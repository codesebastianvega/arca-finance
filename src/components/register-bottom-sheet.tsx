...
export function RegisterBottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      <button type="button" aria-label="Cerrar registro" className="absolute inset-0 bg-[rgba(10,8,6,0.58)]" onClick={onClose} />
      <section
        className="absolute inset-x-0 bottom-0 max-h-[85vh] rounded-t-[28px] border border-[var(--border)] border-b-0 bg-[var(--surface)] shadow-[var(--elevation-strong)]"
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 px-4 pb-3 pt-4">
          ...
          <div className="flex items-center gap-2">
            <Link href="/app/transferir" onClick={onClose}>
