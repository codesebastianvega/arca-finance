  ...
  return (
    <>
      <div className="flex items-center space-x-2">
        ...
        <button type="button" onClick={() => { haptics.medium(); onOpenNova(); }} aria-label="Abrir Nova AI" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-arca-accent/50 bg-gradient-to-tr from-amber-500/25 via-purple-500/20 to-pink-500/25 shadow-[0_0_14px_rgba(245,158,11,0.35)] transition-all hover:scale-105 active:scale-95 hover:border-arca-accent hover:shadow-[0_0_22px_rgba(245,158,11,0.6)]"><NovaLiquidOrb size={36} isThinking={true} /></button>
      </div>
