...
export function DecisionDashboardView({
  ...
  const openRegister = () => window.dispatchEvent(new CustomEvent('open-register'));
          ...
          <div className="flex justify-between items-center">
            ...
            {onOpenMovements ? (
              <button
                ...
                className="text-[9px] font-bold text-[var(--muted)] uppercase tracking-widest hover:text-[var(--primary)] transition-colors flex items-center gap-1"
              >
                Ver movimientos <History size={10} />
              </button>
            ) : null}
          </div>
        ...
        <Card className="overflow-hidden">
          <div className="border-b border-[var(--line)] px-5 py-4">
            <div className="flex justify-between items-center">
              ...
              <button type="button" onClick={openRegister} className="w-6 h-6 rounded-full bg-[var(--surface-2)] flex items-center justify-center text-[var(--muted)] hover:text-[var(--foreground)] hover:bg-[var(--line)] transition-colors">
                <Plus size={14} />
              </button>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={openRegister} className="w-5 h-5 rounded-full bg-[var(--surface-2)] flex items-center justify-center text-[var(--muted)] hover:text-[var(--foreground)] hover:bg-[var(--line)] transition-colors">
                    <Plus size={12} />
                  </button>
                </div>
              </div>
